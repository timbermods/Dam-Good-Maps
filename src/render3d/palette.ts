...
export { BADWATER, blendWater, badwaterBody, cleanWaterBody, WATER, WATER_BLEND, WATER_CALIBRATION, WATER_PLACEHOLDERS, WATER_SURFACE, waterBlend, waterBody, waterOpacity, type Rgb } from "./waterPalette";
