...
| Power location | At least two flux bands each ≥20%; vary accessible geothermal opportunity separately, including “none within 64”. | Do not add hp or “power rich” claims until U01 is resolved. Changing field counts beyond current settings requires a proposal, not silent variation. |
...
- **Opening witness:** legal pump footprint, road connection, accessible logs and ripe food, followed by a feasible work sequence.
  Use the shortest temperate window and longest first drought in the notes. Until U03/U04/U11 are checked, say “unverified”.
