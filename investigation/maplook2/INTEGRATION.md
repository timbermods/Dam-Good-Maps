...
The same texture carries contamination. Two small wet-neighbour smoothing passes and bilinear sampling create a multi-tile front while preserving pure clean/badwater regions. Do not diffuse across dry separators or different surface heights. Colour follows concentration through a mostly-clean warm tint, then murky crimson red; no stochastic red/blue mask. Retain raw contamination for inspection/editing. Clean colours are unchanged. Badwater keeps its crimson body and dark troughs, with subdued brick-red streaks from the same advected texture. Make its surface matte: sparse facets are strongly attenuated, with almost no angular sky lift, so bright salmon highlights do not overwhelm the body. Keep the body nearly opaque (97.5–99.5%) and expose the poisoned bed only at very shallow edges, with smooth depth/shore fades. Fade the thicker response in above the mostly-clean concentration anchor so the front stays soft. Compensate streak contrast for transmission without changing the underlying motion. Keep the existing slow glowing bubble cue. Calibrate body, trough and streak samples through final lighting/blending at documented depths and angles. Waterfall curtains and foam formulas retain their treatment.
