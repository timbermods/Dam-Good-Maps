Historical baseline from commit c9874e2, before designed water. Original method: [METHODS-BASELINE.md](METHODS-BASELINE.md). Current results: [REPORT.md](REPORT.md).
