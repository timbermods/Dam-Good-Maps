# Pick a place attribution

Water reference: © ESA WorldCover project 2021 / Contains modified Copernicus Sentinel data (2021) processed by ESA WorldCover consortium.

ESA WorldCover 10 m 2021 v200, class 80 (permanent water bodies), accessed 2026-09-26 from https://registry.opendata.aws/esa-worldcover-vito/ and the official ESA WorldCover AWS bucket. Licensed CC BY 4.0: https://creativecommons.org/licenses/by/4.0/ . Source and acknowledgement: https://esa-worldcover.org/en/data-access . Citation: Zanaga, D., Van De Kerchove, R., Daems, D., et al. (2022), ESA WorldCover 10 m 2021 v200, https://doi.org/10.5281/zenodo.7254221 . Modified: native water pixels aggregated into game cells; designed underwater beds, springs and boundary inflows; game simulation. This is a reference classification, not a current hydrographic survey or measured bathymetry.
...
Changes: bilinear resampling, cropped patches, vertical mapping and integer quantisation; inferred underwater beds within observed water cells, designed game water sources, natural slopes, simulated water and planted game resources. No terrain walls or rims. Water openings at the edge use source footprints and their normal game boundary behaviour. These are modified data, not endorsed by the providers.

No Google imagery or elevation is used. A pasted coordinate is only a location. Notices apply to the previews as well as map exports. Local code is adapted from the MIT-licensed Dam Good Maps landscape pipeline.
