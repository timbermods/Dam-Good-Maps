...
| Path | What it is |
|---|---|
| `requests.json` | The request corpus: 127 requests in 13 kinds, with their map setups, goals, expectations, feasibility, what the report must say, pass criteria and a reference solution. Written by `bin/corpus.ts`. |
