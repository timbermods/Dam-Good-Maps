...
- carve {from [x, y] or where (its start: the highest dry ground there), to (optional: an aimed end, a tile or a place), power 0–100 or creek|torrent|river|catastrophe, width 2–24 (left out: it follows power), wander 0–100, walls steep|wide, river keep|dry, defyGravity (aimed, to cut uphill), seconds}: the editor's Carve, a force of nature. It finds its own way down (or to its end), cuts a canyon, lays what it cuts as a fan where it ends, and keeps a source at its start (river keep) whose strength follows its width; objects on the cut ground go. Its report says how far it ran, how much it cut and why it ended.
