...
| Berries near start | 20 – 100 | by difficulty (Easy 20, Normal 48, Hard 60; from M8 Easy 40, D85): the generation target, never below the minimum §5.6 gives, which validation enforces (from M8: Minimum starting bushes) | Living bushes within 20 tiles of the start, in 2–3 patches beside water. |
...
Imported maps use their difficulty's defaults. Sources: the water distances are the workshop
