...
| D208 | **Themes become optional leanings, not templates** (for M9b; design version 2 is frozen, D189). The generator's default is "Any" (Surprise me): it combines landforms, water features and intentions freely across the whole space. Choosing a theme only leans the generator toward that kind of land, still varied within by Variety and intentions. Measured: "Any" maps stay coherent and playable, and no theme's maps cluster into an archetype (D108). | Kyler: themes shouldn't be templates. | Kyler's decision, 2026-09-26 |
